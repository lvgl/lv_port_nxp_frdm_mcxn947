...
#define DEMO_FB_ALIGN 4
#define DEMO_FB_SIZE ((LCD_VIRTUAL_BUF_SIZE * LCD_FB_BYTE_PER_PIXEL + LV_DRAW_BUF_ALIGN - 1)  & ~(LV_DRAW_BUF_ALIGN-1))
...
void lv_port_disp_init(void)
{
     ...
     */
    memset(s_frameBuffer, 0, sizeof(s_frameBuffer));
    lv_display_set_buffers(disp, s_frameBuffer[0], s_frameBuffer[1], DEMO_FB_SIZE, LV_DISPLAY_RENDER_MODE_PARTIAL);
}
